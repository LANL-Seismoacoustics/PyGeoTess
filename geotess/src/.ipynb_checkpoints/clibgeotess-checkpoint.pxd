...
cdef extern from "GeoTessData.h" namespace "geotess":
    cdef cppclass GeoTessData:
        ...
        #RAD changes void setValue for float and int, static methods getData
        void setValue(int attributeIndex, float v)
        void setValue(int attributeIndex, int v)
        int size() const
        #RAD  static methods getData
        @staticmethod
...
#RAD added GeoTessProfileSurface ... need to think about this    
cdef extern from "GeoTessProfileSurface.h" namespace "geotess":
    cdef cppclass GeoTessProfileSurface(GeoTessProfile):
        ...
        # void resetPointIndices()
        # int getPointIndex(int nodeIndex) const
        GeoTessProfileSurface* copy() 
        
        
#RAD added GeoTessProfileType       
